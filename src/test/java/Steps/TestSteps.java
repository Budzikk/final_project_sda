...
public class TestSteps extends BaseUtil {
    ...
    public void iEnterMyCredentials() {
        ...
        base.Driver.findElement(By.xpath("/html//input[@id='email']")).sendKeys("ImBatman@gmail.com");

        base.Wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html//input[@id='passwd']")));
        base.Driver.findElement(By.xpath("/html//input[@id='passwd']")).sendKeys("Joker12");

    }

    @And("I click sigh in")
    public void iClickSighIn() {
